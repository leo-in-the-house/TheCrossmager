...
public class AbstractDungeonPatches
{
    ...
    public static class AbstractDungeonPatches_GetEvent
    {
        ...
        {
            final AbstractEvent event = EYBEvent.GenerateSpecialEvent(CardCrawlGame.dungeon, rng, GameUtilities.IsPlayerClass(GR.Animator.PlayerClass));
            if (event != null)
            {
    ...
    public static class AbstractDungeonPatches_DungeonTransitionSetup
    {
        ...
        public static void Prefix()
        {
            ...
            {
                final int ascension = GameUtilities.GetAscensionLevel();
                for (EYBMonsterInfo e : EYBMonster.Encounters)
                {
                    if (ascension < e.minimumAscension)
                    {
                        continue;
                    }
    ...
    public static class AbstractDungeonPatches_NextRoomTransition
    {
        ...
        public static void Prefix(AbstractDungeon __instance, SaveFile saveFile)
        {
            ...
            if (room instanceof OnRoomTransitionListener)
            {
                ((OnRoomTransitionListener)room).OnRoomTransition(room);
            }
        }
    }
