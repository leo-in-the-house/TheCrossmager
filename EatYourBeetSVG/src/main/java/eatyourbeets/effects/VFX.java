...
public class VFX
{
    ...
    public static BiteEffect2 Bite(float cX, float cY)
    {
        return new BiteEffect2(cX, cY, Color.WHITE);
    }
    ...
    public static PotionBounceEffect2 PotionBounce(Hitbox source, Hitbox target)
    {
        return new PotionBounceEffect2(source.cX, source.cY, target.cX, target.cY);
    }
