...
public class IsuzuTonan extends AnimatorClassicCard
{
    public static final EYBCardData DATA = Register(IsuzuTonan.class).SetSeriesFromClassPackage().SetSkill(1, CardRarity.COMMON, EYBCardTarget.None);
