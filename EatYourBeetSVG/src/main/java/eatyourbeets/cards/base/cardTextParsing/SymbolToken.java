...
public class SymbolToken extends CTToken
{
    ...
    static
    {
        ...
        animator.map.put("O", new SymbolToken(animator.playerClass, "[O]"));
        animator.map.put("P", new SymbolToken(animator.playerClass, "[P]"));
        animator.map.put("Y", new SymbolToken(animator.playerClass, "[Y]"));
        animator.map.put("T", new SymbolToken(animator.playerClass, "[T]"));
        animator.map.put("V", new SymbolToken(animator.playerClass, "[V]"));
