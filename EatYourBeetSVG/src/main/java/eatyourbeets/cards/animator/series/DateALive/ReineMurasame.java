...
public class ReineMurasame extends AnimatorCard
{
    ...
    static
    {
        DATA.AddPreview(new eatyourbeets.cards.animator.beta.series.DateALive.ShidoItsuka(), true);
    }
    ...
    public void OnUse(AbstractPlayer p, AbstractMonster m, CardUseInfo info)
    {
        ...
        {
            GameActions.Bottom.MakeCardInDrawPile(new eatyourbeets.cards.animator.beta.series.DateALive.ShidoItsuka())
