...
public class AnimatorClassicVestaElixirEffects
{
    ...
    public AnimatorClassicVestaElixirEffects(Vesta vesta, boolean upgraded)
    {
        this.vesta = vesta;
        ...
        if (rng == null)
        {
            JUtils.LogInfo(AnimatorClassicVestaElixirEffects.class, "EYBCard.rng was null");
            rng = new Random();
        }
    ...
    {
        final AnimatorClassicVestaElixirEffects effects = new AnimatorClassicVestaElixirEffects(vesta, upgraded);
