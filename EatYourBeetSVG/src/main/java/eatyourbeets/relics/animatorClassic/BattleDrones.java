...
public class BattleDrones extends AnimatorClassicRelic implements OnSynergySubscriber
{
        ...
        if (card != null)
        {
            GameActions.Bottom.Callback(()->
            {
                ...
                .SetDamageEffect(enemy ->
                {
                    ...
                    return GameEffects.List.Add(new SmallLaserEffect(enemy.hb.cX, enemy.hb.cY, player.hb.cX, player.hb.cY)).duration;
                });
