...
public class VividPicture extends AnimatorClassicRelic implements OnSynergySubscriber
{
    ...
    public void obtain()
    {
        ...
        {
            if (relics.get(i).relicId.equals(eatyourbeets.relics.animator.LivingPicture.ID))
            {
