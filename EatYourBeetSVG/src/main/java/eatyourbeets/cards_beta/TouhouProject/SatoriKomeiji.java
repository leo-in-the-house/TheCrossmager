...
public class SatoriKomeiji extends AnimatorCard
{
    ...
    public void OnUse(AbstractPlayer p, AbstractMonster m, CardUseInfo info)
    {
        ...
        GameActions.Bottom.StackPower(new SatoriKomeijiPower(p, magicNumber));
    }

    public static class SatoriKomeijiPower extends AnimatorPower
    {
        public SatoriKomeijiPower(AbstractCreature owner, int amount)
        {
